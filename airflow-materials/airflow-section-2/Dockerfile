...
RUN pip install --upgrade pip && \
    ...
    pip install apache-airflow[crypto,celery,postgres,hive,mysql,ssh,docker,hdfs,kubernetes,redis,rabbitmq,slack]==${AIRFLOW_VERSION} --constraint /requirements-python3.5.txt
