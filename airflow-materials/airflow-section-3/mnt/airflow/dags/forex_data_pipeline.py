...
with DAG(dag_id="forex_data_pipeline", schedule_interval="@daily", default_args=default_args, catchup=False) as dag:
    ...
    is_forex_currency_file_available = FileSensor(
        task_id="is_forex_currency_file_available",
    ...
    is_forex_rates_available >> is_forex_currency_file_available >> downloading_rates >> saving_rates >> creating_forex_rates_table >> forex_processing >> sending_email_notification >> sending_slack_notification
